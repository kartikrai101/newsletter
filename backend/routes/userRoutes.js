...
const {register, verifyEmail, login, authenticateUser, authenticateAdmin, getAllPosts, refreshToken, createPost, getPost, updatePost, deletePost, likePost, likes, createComment, getComments, updateComment, deleteComment} = require('../controllers/userController');
